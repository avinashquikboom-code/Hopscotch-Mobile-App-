      ...
      'sections': [
        {
          ...
          'body': 'By purchasing custom tailored or bespoke-fitting garments from Aura Couture, you acknowledge and agree that minor visual adjustments and drape alignments may occur during the physical tailoring phase. Because each item is constructed based on individual clients\' specified measurements, variations are custom-tailored to provide the ultimate styling fit.'
        },
        {
          'heading': '2. Proprietary Couture Designs',
          'body': 'All designs, custom knitwear weaves, silk patterns, embroidery drapes, and application structures featured inside the Aura Couture catalog represent exclusive, patented intellectual property owned by Aura Couture and its collaborative European design houses. Unauthorized reproduction or reverse-engineering is strictly prohibited.'
        },
        {
          'heading': '3. Order Cancellation Window',
          'body': 'Due to our rapid white-glove logistics pipeline and immediate stock reservation system, orders may only be cancelled or modified within exactly one (1) hour of secure transaction authorization. Once custom physical preparation or tailoring begins at our ateliers, cancellations are no longer accepted.'
        }
      ]
    },
    {
      ...
      'sections': [
        {
          ...
          'body': 'If you choose to authorize billing or purchase secure keys using biometric data, your fingerprint or facial signature never leaves your physical mobile device. Biometric data is strictly encapsulated inside your native device hardware\'s Secure Enclave/Keymaster. Aura Couture never accesses, transmits, or caches biometric identifiers.'
        },
        {
          'heading': '2. Encrypted Data Streams',
          'body': 'All customer profiles, styling metrics, order logistics, and transaction credentials are securely compiled and encrypted end-to-end using industry-standard TLS 1.3 encryption streams. We do not distribute or monetize customer data to third-party advertising cooperatives.'
        },
        {
          'heading': '3. Personal styling measurements',
          'body': 'Your bespoke styling profiles, height metrics, and measurement logs reside within heavily secured, isolated database matrices. This data is exclusively parsed by your designated personal concierges and atelier tailors to ensure correct custom fitting.'
        }
      ]
    },
    {
      ...
      'sections': [
        {
          ...
          'body': 'All luxury shipments are fully insured and dispatched via elite, high-speed priority couriers (DHL Express and FedEx Priority). Hand-wrapped, customized boxes require physical signature authorization upon delivery to guarantee secure, damage-free transfer.'
        },
        {
          'heading': '2. Complaints and Alteration Ateliers',
          'body': 'Aura Couture operates under an elite styling guarantee. If a custom garment does not fit to your total satisfaction, we provide complimentary alteration credits. alter your garment at any of our collaborative luxury tailoring ateliers globally. Simply contact your Concierge to receive an authorized atelier voucher.'
        },
        {
          'heading': '3. Customs & Import Tariffs',
          'body': 'For global couture dispatches shipped internationally across European borders, import tariffs and local luxury taxes are fully pre-calculated and authorized at checkout, ensuring complete white-glove logistics processing straight to your destination.'
        }
      ]
    }
  ];
